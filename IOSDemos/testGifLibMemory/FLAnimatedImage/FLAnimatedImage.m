...
- (void)setFrameCacheSizeMax:(NSUInteger)frameCacheSizeMax
{
    ...
    {
        // Remember whether the new cap will cause the current cache size to shrink;
        // then we'll make sure to purge from the cache if needed.
...
- (instancetype)initWithAnimatedGIFData:(NSData *)data
{
    ...
    if (self)
    {
        ...
        NSMutableArray *delayTimesMutable = [[NSMutableArray alloc] initWithCapacity:imageCount];
...
- (NSIndexSet *)frameIndexesToCache
{
    ...
    else
    {
        ...
        indexesToCache = indexesToCacheMutable;
    }
