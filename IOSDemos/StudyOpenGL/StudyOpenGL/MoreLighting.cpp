...
double MoreLighting::gScrollY = 0; //static variable should be initilized in source file

MoreLighting::MoreLighting()
{
    window = nullptr;
    gScrollY = 0;
    degreesRotated = 0;
...
tdogl::Program* MoreLighting::loadShaders()
{
...
tdogl::Texture* MoreLighting::loadTexture()
{
...
void MoreLighting::loadWoodenCrateAsset()
{
...
void MoreLighting::createInstance()
{
    ModelInstance dot;
...
void MoreLighting::renderInstance(const ModelInstance &inst)
{
...
void MoreLighting::update(float secondsElapsed)
{
...
void MoreLighting::onScroll(GLFWwindow *window, double deltax, double deltay)
{
    gScrollY += deltay;
}

void MoreLighting::onError(int errorCode, const char *msg)
{
    throw std::runtime_error(msg);
}

void MoreLighting::appMain()
{
