...
double AssetDogger::gScrollY = 0; //static variable should be initilized in source file

AssetDogger::AssetDogger()
{
    window = nullptr;
    gScrollY = 0;
    degreesRotated = 0;
...
tdogl::Program* AssetDogger::loadShaders()
{
    std::vector<tdogl::Shader> shaders;
    shaders.push_back(tdogl::Shader::shaderFromFile(ResourcePath("asset_vertex_shader.glsl"), GL_VERTEX_SHADER));
    shaders.push_back(tdogl::Shader::shaderFromFile(ResourcePath("asset_fragment_shader.glsl"), GL_FRAGMENT_SHADER));
    return new tdogl::Program(shaders);
}

tdogl::Texture* AssetDogger::loadTexture()
{
...
void AssetDogger::loadWoodenCrateAsset()
{
...
void AssetDogger::createInstance()
{
    ModelInstance dot;
...
void AssetDogger::renderInstance(const ModelInstance &inst)
{
...
void AssetDogger::update(float secondsElapsed)
{
...
void AssetDogger::onScroll(GLFWwindow *window, double deltax, double deltay)
{
    gScrollY += deltay;
}

void AssetDogger::onError(int errorCode, const char *msg)
{
    throw std::runtime_error(msg);
}

void AssetDogger::appMain()
{
